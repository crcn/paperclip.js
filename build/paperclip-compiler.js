(function() {
    ...
    define("paperclip/lib/translate/index.js", function(require, module, exports, __dirname, __filename) {
        ...
        formatter = require("paperclip/lib/translate/template/formatter.js");
    ...
    define("paperclip/lib/translate/template/formatter.js", function(require, module, exports, __dirname, __filename) {
    ...
    define("uglify-js/uglify-js.js", function(require, module, exports, __dirname, __filename) {
        ...
        uglify.parser = require("uglify-js/lib/parse-js.js");
        uglify.uglify = require("uglify-js/lib/process.js");
        uglify.consolidator = require("uglify-js/lib/consolidator.js");
    ...
    define("uglify-js/lib/parse-js.js", function(require, module, exports, __dirname, __filename) {
            ...
            function read_string() {
                return with_eof_error("Unterminated string constant", function() {
                    ...
                    for (;;) {
                        ...
                        } else if (ch == quote) break; else if (ch == "\n") throw EX_EOF;
                        ret += ch;
                    }
    ...
    define("uglify-js/lib/process.js", function(require, module, exports, __dirname, __filename) {
        var jsp = require("uglify-js/lib/parse-js.js"), curry = jsp.curry, slice = jsp.slice, member = jsp.member, is_identifier_char = jsp.is_identifier_char, PRECEDENCE = jsp.PRECEDENCE, OPERATORS = jsp.OPERATORS;
        function ast_walker() {
        ...
        function squeeze_2(ast, options) {
            ...
            return w.with_walkers({
                directive: function(dir) {
                    if (scope.active_directive(dir)) return [ "block" ];
        ...
        function gen_code(ast, options) {
            ...
            return w.with_walkers({
                ...
                call: function(func, args) {
                    ...
                    if (!already_wrapped && needs_parens(func)) f = "(" + f + ")";
            ...
            function make_switch_block(body) {
                ...
                return "{" + newline + MAP(body, function(branch, i) {
                    ...
                    }, .5) + (has_body ? newline + with_indent(function() {
        ...
        exports.MAP = MAP;
        exports.ast_squeeze_more = require("uglify-js/lib/squeeze-more.js").ast_squeeze_more;
        return module.exports;
    });
    define("uglify-js/lib/consolidator.js", function(require, module, exports, __dirname, __filename) {
        exports["ast_consolidate"] = function(oAbstractSyntaxTree) {
            ...
            var _, TSourceElementsData = function() {
                ...
                this.nSavings = 0;
            }, oProcessor = require("uglify-js/lib/process.js"), oWeights = {
    ...
    define("uglify-js/lib/squeeze-more.js", function(require, module, exports, __dirname, __filename) {
        var jsp = require("uglify-js/lib/parse-js.js"), pro = require("uglify-js/lib/process.js"), slice = jsp.slice, member = jsp.member, curry = jsp.curry, MAP = pro.MAP, PRECEDENCE = jsp.PRECEDENCE, OPERATORS = jsp.OPERATORS;
