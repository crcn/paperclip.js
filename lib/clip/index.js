...
var Clip, ClipScript, ClipScripts, PropertyChain, bindable, dref, events,
...
ClipScript = (function(_super) {
  ...
  */
  ...
  function ClipScript(script, clip) {
    this.script = script;
    this.clip = clip;
    this._watchBindable = __bind(this._watchBindable, this);
  ...
  */
  ...
  ClipScript.prototype._watch = function(path, target) {
    ...
    return this._watching[path] = {
      target: target,
      binding: target.bind(path).to(this._watchBindable).now().to(this.update)
    };
  };
  ...
  */
  ...
  ClipScript.prototype._watchBindable = function(value, oldValue) {
    ...
    if (oldValue != null) {
      if (typeof oldValue.off === "function") {
        oldValue.off("change", this.update);
      }
    }
    value.off("change", this.update);
