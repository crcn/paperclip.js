  ...
  ClipScript = (function(_super) {
    ...
    */
    ...
    ClipScript.prototype.update = function() {
      ...
      this._watchRefs();
      this._locked = true;
      newValue = this.script.fn.call(this.__context);
      this._locked = false;
    ...
    ClipScript.prototype._watchRefs = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        _results.push((function(ref) {
          var bindableBinding, binding, locked;

          bindableBinding = void 0;
          locked = true;
          _this._bindings.push(binding = _this.__context.bind(ref, function(value, oldValue) {
            if (bindableBinding) {
