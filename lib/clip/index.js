...
protoclass(ClipScript, {
  ...
  update: function () {
    ...
    // note that the context might not exist since the script might
    // trigger a dispose event, such as closing a modal
    // TODO - bind on animate?
    if (this.__context) this._watchRefs();
