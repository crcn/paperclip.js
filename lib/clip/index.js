  ...
  */
  ...
  ClipScript = (function(_super) {
    ...
    */
    ...
    ClipScript.prototype._g = function(path) {
      var cv;

      cv = this.clip.data.get(path);
      this._watch(path, this.clip.data);
      return cv;
    };
    ...
    */
    ...
    ClipScript.prototype._s = function(path, value) {
      this.clip.data.set(path, value);
      this._watch(path, this.clip.data);
      return value;
    };
    ...
    */
    ...
    ClipScript.prototype._debounceUpdate = function() {
      ...
      return this._debounceTimeout = setTimeout((function() {
        return _this.update();
      }), 0);
    };
