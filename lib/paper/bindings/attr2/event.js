...
EventDecor = (function(_super) {
  ...
  */
  ...
  EventDecor.prototype.bind = function() {
    ...
    return (this.$element = $(this.element)).bind(this._bindEvent = event, this._onEvent);
  };
  ...
  */
  ...
  EventDecor.prototype.dispose = function() {
    var _ref1;

    return (_ref1 = this.$element) != null ? _ref1.unbind(this._bindEvent, this._onEvent) : void 0;
  };
