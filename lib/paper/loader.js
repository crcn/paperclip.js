  ...
  Loader = (function() {
    ...
    */
    ...
    Loader.prototype.load = function(context) {
      ...
      this.section.append(this._templateNodeClone = this._createTemplateNodeClone());
      return this;
    };
    ...
    */
    ...
    Loader.prototype._createTemplateNodeClone = function() {
      ...
      return this.template.node = node;
    };
    ...
    */
    ...
    Loader.prototype.bind = function() {
      this.bindings.bind(this.context, this._templateNodeClone);
      return this;
    };
