...
Base = (function() {
  ...
  */
  ...
  Base.prototype.load = function(stream) {
    this.stream = stream;
    this.target = this.createNode(stream);
    this._loadChildren(stream);
    return this;
  };
  ...
  */
  ...
  Base.prototype._loadChildren = function(stream) {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      child = _ref[_i];
      _results.push(this.target.appendChild(child.load(stream)));
    }
    return _results;
  };
  ...
  */
  ...
  Base.prototype.createNode = function(stream) {
    return stream.createElement("div");
  };
