...
BlockBinding = (function(_super) {
  ...
  */
  ...
  BlockBinding.prototype.load = function(writer) {
    this.clip.reset(writer.context);
    this.clip.update();
    return BlockBinding.__super__.load.call(this, writer);
  };
  ...
  */
  ...
  BlockBinding.prototype.createNode = function(writer) {
    return writer.createFragment();
  };
