...
NodeBinding = (function(_super) {
  ...
  */
  ...
  NodeBinding.prototype._load = function(writer) {
    this.target = writer.createElement(this.name);
    return NodeBinding.__super__._load.call(this, writer);
  };
  ...
  */
  ...
  NodeBinding.prototype._loadChildren = function(writer) {
    this._decor.load(writer);
    return NodeBinding.__super__._loadChildren.call(this, writer);
  };
