...
NodeBinding = (function(_super) {
  ...
  */
  ...
  NodeBinding.prototype._load = function(stream) {
    this.target = stream.createElement(this.name);
    return NodeBinding.__super__._load.call(this, stream);
  };
  ...
  */
  ...
  NodeBinding.prototype._loadChildren = function(stream) {
    this._decor.load(stream);
    return NodeBinding.__super__._loadChildren.call(this, stream);
  };
