...
BlockWriter = (function(_super) {
  ...
  */
  ...
  BlockWriter.prototype.write = function(script, contentFactory, childBindings) {
    ...
    this.bindings.push(new ClipBinding(clip));
    (_ref1 = this.bindings).push.apply(_ref1, blockBindingFactory.getBindings(section, clip, this.nodeFactory));
