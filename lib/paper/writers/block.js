...
BlockChild = (function(_super) {
  ...
  */
  ...
  BlockChild.prototype.load = function(paper) {
    if (!this["with"]) {
      return BlockChild.__super__.load.call(this, paper);
    }
  ...
  */
  ...
  BlockChild.prototype._loadChildren = function(paper) {
    return this.content.load(paper);
  };
...
BlockBinding = (function(_super) {
  ...
  */
  ...
  BlockBinding.prototype.replaceAll = function() {
    ...
    this.node = newFragment = arguments.length > 1 ? (_ref = this.paper.nodeFactory).createFragment.apply(_ref, arguments) : arguments[0];
  ...
  */
  ...
  BlockBinding.prototype.load = function(paper) {
    this.clip.reset(paper.context);
    this.clip.update();
    return BlockBinding.__super__.load.call(this, paper);
  };
  ...
  */
  ...
  BlockBinding.prototype._loadChildren = function(paper) {
    return this._decor.load(paper.context);
  };
