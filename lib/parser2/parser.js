module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c10 = function(children) { return new ArrayExpression(new ParametersExpression(children)) },
        peg$c11 = "<!--",
        ...
        peg$c19 = function(value) {
              return new TextNodeExpression(trimWhitespace(value.join("")))
            },
        peg$c20 = "<",
        ...
        peg$c44 = function() { return new StringExpression(trimmedText()); },
        peg$c45 = function(values) { return values.length > 1 ? new ArrayExpression(new ParametersExpression(values)) : values[0] || new StringExpression(""); },
        peg$c46 = "'",
        ...
        peg$c52 = function(blockBinding) { return blockBinding; },
        ...
        peg$c65 = function(script) {
              return new HashExpression({ value: new ScriptExpression(script) });
            },
        ...
        peg$c71 = function(condition, left, right) {
        ...
        peg$c82 = function(param1, rest) {
              return [param1].concat(rest.map(function (v) {
                return v[1];
              }));
            },
        peg$c83 = function(left, right) {
        ...
        peg$c116 = function(expression, modifiers) {

              for (var i = 0, n = modifiers.length; i < n; i++) {
                expression = new ModifierExpression(modifiers[i].reference, new ParametersExpression([expression].concat(modifiers[i].parameters)));
              }
        ...
        peg$c119 = null,
        peg$c120 = function(reference, parameters) {
            return {
              reference: reference,
              parameters: parameters || []
            }
          },
        peg$c121 = function(context) { return context; },
        peg$c122 = "!",
        peg$c123 = { type: "literal", value: "!", description: "\"!\"" },
        peg$c124 = function(not, value) {
        ...
        peg$c130 = function(group) { return new GroupExpression(group); },
        ...
        peg$c137 = "undefined",
        peg$c138 = { type: "literal", value: "undefined", description: "\"undefined\"" },
        peg$c139 = function() { return { type: "undefined", value: void 0 }; },
        peg$c140 = "NaN",
        peg$c141 = { type: "literal", value: "NaN", description: "\"NaN\"" },
        peg$c142 = function() { return { type: "nan", value: NaN }; },
        peg$c143 = "Infinity",
        peg$c144 = { type: "literal", value: "Infinity", description: "\"Infinity\"" },
        peg$c145 = function() { return { type: "infinity", value: Infinity }; },
        peg$c146 = "null",
        peg$c147 = { type: "literal", value: "null", description: "\"null\"" },
        peg$c148 = "NULL",
        peg$c149 = { type: "literal", value: "NULL", description: "\"NULL\"" },
        peg$c150 = function() { return { type: "null", value: null }; },
        peg$c151 = function(reference, parameters) {
        ...
        peg$c160 = function(bindingType, reference, path) {
              path = [reference].concat(path.map(function (p) { return p[1] }));
              return new ReferenceExpression(path, bindingType);
            },
        peg$c161 = /^[a-zA-Z_$0-9]/,
        peg$c162 = { type: "class", value: "[a-zA-Z_$0-9]", description: "[a-zA-Z_$0-9]" },
        peg$c163 = function(name) { return text(); },
        peg$c164 = "{",
        peg$c165 = { type: "literal", value: "{", description: "\"{\"" },
        peg$c166 = "}",
        peg$c167 = { type: "literal", value: "}", description: "\"}\"" },
        peg$c168 = function(values) {
        ...
        peg$c170 = function(firstValue, additionalValues) {
              return [
                firstValue
        ...
        peg$c172 = function(key) { return key.value; },
        peg$c173 = function(key) { return key; },
