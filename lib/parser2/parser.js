module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c109 = function(left, operator, right) {
              return {
                type: operator,
                left: left,
                right: right
        ...
        peg$c112 = function(value, modifiers) { 
              value.modifiers = modifiers.map(function (modifier) {
                return modifier[1];
              });
              return value; 
            },
        peg$c113 = function(call) {
            return {
              type: "call",
        ...
        peg$c116 = function(context, path) {
              context.path = path.map(function (p) { return p[1] })
              return context;
            },
        peg$c117 = "!",
        peg$c118 = { type: "literal", value: "!", description: "\"!\"" },
        peg$c119 = function(not, value) {
              return { 
                type: "!",
                value: value
              }
        ...
        peg$c123 = function(value) { return { type: "number", value: parseFloat(text()) }; },
        peg$c124 = function(group) { return group; },
        peg$c125 = "true",
        peg$c126 = { type: "literal", value: "true", description: "\"true\"" },
        peg$c127 = "false",
        peg$c128 = { type: "literal", value: "false", description: "\"false\"" },
        ...
        peg$c132 = function() { return { type: "undefined", value: void 0 }; },
        peg$c133 = "NaN",
        peg$c134 = { type: "literal", value: "NaN", description: "\"NaN\"" },
        peg$c135 = function() { return { type: "nan", value: NaN }; },
        peg$c136 = "Infinity",
        peg$c137 = { type: "literal", value: "Infinity", description: "\"Infinity\"" },
        peg$c138 = function() { return { type: "infinity", value: Infinity }; },
        peg$c139 = "null",
        peg$c140 = { type: "literal", value: "null", description: "\"null\"" },
        peg$c141 = "NULL",
        peg$c142 = { type: "literal", value: "NULL", description: "\"NULL\"" },
        peg$c143 = function() { return { type: "null", value: null }; },
        peg$c144 = function(reference, parameters) {
              return {
                type: "call",
                reference: reference,
        ...
        peg$c153 = function(bindingType, reference) {
              return {
                type: "reference",
        ...
        peg$c154 = /^[a-zA-Z_$0-9]/,
        peg$c155 = { type: "class", value: "[a-zA-Z_$0-9]", description: "[a-zA-Z_$0-9]" },
        peg$c156 = function(name) { return text(); },
        peg$c157 = "{",
        peg$c158 = { type: "literal", value: "{", description: "\"{\"" },
        peg$c159 = "}",
        peg$c160 = { type: "literal", value: "}", description: "\"}\"" },
        peg$c161 = function(values) {
              return {
                type: "object",
                value: values
              }
            },
        peg$c162 = function(firstValue, additionalValues) {
              return [
                firstValue
        ...
        peg$c174 = { type: "any", description: "any character" },
        peg$c175 = /^[a-zA-Z]/,
        peg$c176 = { type: "class", value: "[a-zA-Z]", description: "[a-zA-Z]" },
