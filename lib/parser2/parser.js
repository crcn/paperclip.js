module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c31 = function(values) { return values; },
        peg$c32 = "'",
        ...
        peg$c38 = function(bindingBlock) { return bindingBlock; },
        peg$c39 = "}}",
        peg$c40 = { type: "literal", value: "}}", description: "\"}}\"" },
        peg$c41 = function(scripts, fragment, child) {
            return {
              type: "bindingBlock",
              scripts: scripts,
              fragment: fragment,
        ...
        peg$c47 = function(script) {
              return {
                type: "binding",
                scripts: script
              };
            },
        peg$c48 = function(scripts) {
                var s = {};
        ...
        peg$c49 = function(script) {
              return {
                value: script
              };
            },
        peg$c50 = function(expression) {
            return expression;
          },
        peg$c51 = "?",
        ...
        peg$c55 = function(condition, left, right) {
              return {
                type: "condition",
                condition: condition,
                left: left,
        ...
        peg$c84 = function(left, operator, right) {
              return {
                type: operator,
                left: left,
                right: right
        ...
        peg$c89 = function(left, operation, right) {
              return {
                type: operation,
                left: left,
                right: right
        ...
        peg$c92 = function(left, operation, right) {
              return {
                type: operation,
                left: left,
                right: right
        ...
        peg$c99 = function(value, modifiers) { 
              value.modifiers = modifiers.map(function (modifier) {
                return modifier[1];
              });
              return value; 
            },
        peg$c100 = function(call) {
            return {
              type: "call",
        ...
        peg$c103 = function(context, path) {
        ...
        peg$c110 = function(value) { return { type: "number", value: parseFloat(text()) }; },
        peg$c111 = function(group) { return group; },
        peg$c112 = "true",
        ...
        peg$c117 = "undefined",
        peg$c118 = { type: "literal", value: "undefined", description: "\"undefined\"" },
        peg$c119 = function() { return { type: "undefined", value: void 0 }; },
        peg$c120 = "NaN",
        peg$c121 = { type: "literal", value: "NaN", description: "\"NaN\"" },
        peg$c122 = function() { return { type: "nan", value: NaN }; },
        peg$c123 = "Infinity",
        peg$c124 = { type: "literal", value: "Infinity", description: "\"Infinity\"" },
        peg$c125 = function() { return { type: "infinity", value: Infinity }; },
        peg$c126 = "null",
        peg$c127 = { type: "literal", value: "null", description: "\"null\"" },
        peg$c128 = "NULL",
        peg$c129 = { type: "literal", value: "NULL", description: "\"NULL\"" },
        peg$c130 = function() { return { type: "null", value: null }; },
        peg$c131 = function(reference, parameters) {
              return {
                type: "call",
                reference: reference,
        ...
        peg$c140 = function(bindingType, reference) {
              return {
                type: "reference",
        ...
        peg$c143 = function(name) { return text(); },
        peg$c144 = "{",
        ...
        peg$c149 = function(firstValue, additionalValues) {
              return [
                firstValue
        ...
        peg$c151 = function(key) { return key.value; },
        ...
        peg$c162 = function(chars) { return chars.join(""); },
        peg$c163 = /^[ \n\r\t]/,
