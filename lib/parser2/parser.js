module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c75 = function(condition, left, right) {
        ...
        peg$c123 = null,
        peg$c124 = function(name, parameters) {
            return {
              name: name,
              parameters: parameters || []
            }
          },
        peg$c125 = function(context) { return context; },
        peg$c126 = "!",
        peg$c127 = { type: "literal", value: "!", description: "\"!\"" },
        peg$c128 = function(not, value) {
        ...
        peg$c134 = function(group) { return new GroupExpression(group); },
        ...
        peg$c143 = function() { return { type: "undefined", value: void 0 }; },
        peg$c144 = "NaN",
        peg$c145 = { type: "literal", value: "NaN", description: "\"NaN\"" },
        peg$c146 = function() { return { type: "nan", value: NaN }; },
        peg$c147 = "Infinity",
        peg$c148 = { type: "literal", value: "Infinity", description: "\"Infinity\"" },
        peg$c149 = function() { return { type: "infinity", value: Infinity }; },
        peg$c150 = "null",
        peg$c151 = { type: "literal", value: "null", description: "\"null\"" },
        peg$c152 = "NULL",
        peg$c153 = { type: "literal", value: "NULL", description: "\"NULL\"" },
        peg$c154 = function() { return { type: "null", value: null }; },
        peg$c155 = function(reference, parameters) {
        ...
        peg$c164 = function(bindingType, reference, path) {
        ...
        peg$c167 = function(name) { return text(); },
        peg$c168 = "{",
        ...
        peg$c174 = function(firstValue, additionalValues) {
              return [
                firstValue
        ...
        peg$c176 = function(key) { return key.value; },
        peg$c177 = function(key) { return key; },
        ...
        peg$c188 = /^[a-zA-Z]/,
        peg$c189 = { type: "class", value: "[a-zA-Z]", description: "[a-zA-Z]" },
    ...
    function peg$parseAttrTextBinding() {
      ...
      if (s1 !== peg$FAILED) {
        s2 = peg$parse_();
        if (s2 !== peg$FAILED) {
          s3 = peg$parseAttrTextBindingScript();
          if (s3 !== peg$FAILED) {
            s4 = peg$parse_();
            if (s4 !== peg$FAILED) {
              if (input.substr(peg$currPos, 2) === peg$c61) {
    ...
    function peg$parseAttrTextBindingScript() {
      var s0, s1;
