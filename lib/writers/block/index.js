...
function writeValue (template, nodeFactory, block) {
  ...
  var node = nodeFactory.createTextNode("undefined"),
...
function writeDynamic (template, nodeFactory, script, contentPaper, childPaper) {
  var section = createSection(nodeFactory);

  template.clips.push({
    section: section,
    contentPaper: contentPaper,
    childPaper: childPaper,
...
module.exports = function (template) {
  ...
  return function (script, contentPaper, childPaper) {
    ...
    return writeDynamic(template, nodeFactory, script, contentPaper, childPaper);
  };
};